...
--// ATUALIZAR CÍRCULO (CORES DO FOV CORRIGIDAS)
...
RunService.RenderStepped:Connect(function()
    ...
    if _G.SilentAim then
        ...
        if CurrentTarget then
            ...
            -- CORREÇÃO: Se não há alvo travado mas há alvos no FOV
            -- O TargetInRange já é atualizado corretamente na função GetTarget()
...
║  • FOV Slider CORRIGIDO (não buga fora)      ║
║  • Wall Check OTIMIZADO (detecta paredes)    ║
