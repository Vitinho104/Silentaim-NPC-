...
--// INTERFACE COMPACTA ATUALIZADA (COM NOVAS OPÇÕES)
local function CreateCompactMobileUI()
    ...
    MainFrame.Size = UDim2.new(0, 320, 0, 420)  -- Aumentado para 420 para caber novas opções
    ...
    HeaderText.Text = "🎯 SILENT AIM v2.9"
    ...
    local Tabs = {"Geral", "Config", "Aim", "Team", "Extra", "NPC", "Info"}
    ...
    for i, tabName in ipairs(Tabs) do
        ...
        TabButton.Size = UDim2.new(0.13, 0, 1, 0)  -- Ajustado para 0.13 para caber mais abas
        TabButton.Position = UDim2.new((i-1) * 0.135, 0, 0, 0)
        TabButton.Text = tabName
        TabButton.TextColor3 = Theme.TextSecondary
        TabButton.BackgroundColor3 = Theme.Secondary
        TabButton.BackgroundTransparency = 0.7
        TabButton.Font = Enum.Font.GothamBold
        TabButton.TextSize = 9  -- Texto menor para caber
        ...
        TabContent.Size = UDim2.new(1, -20, 0, 270)  -- Aumentado para 270
    ...
    StatusBar.Position = UDim2.new(0, 10, 0, 365)  -- Ajustado para 365
...
╚══════════════════════════════════════════════╝]])
    ...
    print("\n[COMANDOS DEBUG - ABA NPC]")
    print("1. Modo Agressivo: " .. tostring(_G.AggressiveNPCDetection))
    print("2. Debug NPCs: " .. tostring(_G.DebugNPCs))
    print("3. Forçar atualização: LastCacheUpdate = 0")
    print("4. Ver NPCs detectados: for k,v in pairs(NPCCache) do print(k.Name) end")
end)
