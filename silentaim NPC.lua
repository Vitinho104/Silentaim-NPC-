...
--// FUNÇÃO: MOSTRAR INFORMAÇÕES DO ALVO (CORRIGIDA COM SHOWHITCHANCE)
local function UpdateTargetInfo()
    ...
    if CurrentTarget and TargetPart then
        ...
        if onScreen then
            ...
            if _G.ShowHitChance and _G.HitChance > 0 then
...
local function CreateCompactMobileUI()
    ...
    HeaderText.Text = "🎯 SILENT AIM v2.7"
    ...
    local function CreateInfoToggle(name, yPosition, defaultValue, icon, description)
        ...
        toggleBtn.MouseButton1Click:Connect(function()
            ...
            -- Atualizar imediatamente as informações do alvo
    ...
    local function UpdateHitChance(value)
        _G.HitChance = math.clamp(value, 0, 100)  -- Permite 0% agora
    ...
    ToggleBtn.MouseButton1Click:Connect(function()
        ...
        if _G.SilentAim then
            ...
            -- Garantir que o texto desapareça quando desativado
            if TargetInfo then
                TargetInfo.Visible = false
                TargetInfo.Text = ""
            end
    ...
    ShowTargetBtn.MouseButton1Click:Connect(function()
        ...
        if _G.ShowTarget then
            ...
            -- Garantir que o texto desapareça
            if TargetInfo then
                TargetInfo.Visible = false
                TargetInfo.Text = ""
            end
...
task.spawn(function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "🎯 SILENT AIM v2.7",
        Text = "Hit Chance corrigido!\n• Agora funciona com 1%\n• Texto desaparece ao desligar",
        Duration = 3,
        Icon = "rbxassetid://4483345998"
    })
...
║                 VERSION 2.7                  ║
║                                              ║
║  ✓ Hit Chance funcionando CORRETAMENTE       ║
║     • 1% realmente tem 1% de chance          ║
║     • 0% = nunca acerta                      ║
║     • 100% = sempre acerta                   ║
║  ✓ Informações desaparecem ao desativar      ║
║  ✓ Botão de ShowHitChance respeitado         ║
